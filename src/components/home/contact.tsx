    ...
    <div id="contact" className="sticky top-0">
      ...
      <div className="h-72 bg-custom-obsidian p-16 m-6 rounded-xl">
        <div className="grid gap-14 md:grid-cols-3 md:gap-5">
          <div className="rounded-xl bg-white p-6 text-center shadow-xl -translate-y-48">
            ...
            <h1 className="text-custom-yellow mb-3 text-xl font-bold md:px-14">Professional Background</h1>
          ...
          <div data-aos-delay="150" className="rounded-xl bg-white p-6 text-center shadow-xl -translate-y-48">
            <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-rose-500 shadow-rose-500/40">
              <svg viewBox=" 0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
                <path d="M12 0C11.0532 0 10.2857 0.767511 10.2857 1.71432V5.14285H13.7142V1.71432C13.7142 0.767511 12.9467 0 12 0Z" fill="#F5F5FC"></path>
                <path d="M36 0C35.0532 0 34.2856 0.767511 34.2856 1.71432V5.14285H37.7142V1.71432C37.7143 0.767511 36.9468 0 36 0Z" fill="#F5F5FC"></path>
                <path
            ...
            <h1 className="text-custom-yellow mb-3 text-xl font-bold md:px-14 ">Collaborative & Reliable</h1>
            <p className="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet modi accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
          </div>
          <div data-aos-delay="300" className="rounded-xl bg-white p-6 text-center shadow-xl -translate-y-48">
            ...
            <h1 className="text-custom-yellow mb-3 text-xl font-bold md:px-14">Vision & Growth</h1>
            <p className="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet modi accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
          </div>
        </div>
      </div>
